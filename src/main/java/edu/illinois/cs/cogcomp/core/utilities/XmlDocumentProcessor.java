...
public class XmlDocumentProcessor implements Serializable{
    ...
    private static final long serialVersionUID = 2630911821559323571L;
    ...
    /** replace intradocument html with xml characters **/
    private final boolean replaceXmlEscapedCharacters;
    /**
    ...
    public XmlDocumentProcessor(Set<String> deletableSpanTags, Map<String, Set<String>> tagsWithAtts,
        ...
        this(deletableSpanTags,tagsWithAtts,singletonTags,throwExceptionOnUnrecognizedTag,true);
    }
    ...
    public XmlDocumentProcessor(Set<String> deletableSpanTags, Map<String, Set<String>> tagsWithAtts,
                                Set<String> singletonTags, boolean throwExceptionOnUnrecognizedTag,
                                boolean replaceXmlEscapedCharacters) {
        this.replaceXmlEscapedCharacters = replaceXmlEscapedCharacters;
    ...
    public Pair<StringTransformation, List<SpanInfo>> processXml(String xmlText) {
        ...
        if(replaceXmlEscapedCharacters)
...
//        Map<String, Integer> nestingLevels = new HashMap<>();
        ...
        while (xmlMatcher.find()) {
            ...
            if (tagMatcher.find()) {
                ...
                boolean bClose = tagName.equals("b") && tagName.equals(tagStack.peek().label);
                if (isClose || bClose) {
...
//                    nestingLevels.put(tagName, nestingLevel);
    ...
    public class SpanInfo implements Serializable{
        ...
        private static final long serialVersionUID = 2568345032648817533L;
