...
TA_IN_DIR="/shared/corpora/corporaWeb/lorelei/evaluation-2018/il10/processed/setE/eng/"
#TA_OUT_DIR="/shared/preprocessed/cddunca2/lorelei/il9/cp2-setE/"
TA_OUT_DIR="/scratch/lorelei-edl/il10/cp2-setE/"

SUBMISSION_DIR="/scratch/lorelei-edl/submission-purgatory"
SUBMISSION="$SUBMISSION_DIR/il10_cp2.tab"
ILCODE=10
